        ...
        <div class="row m-b-3 m-t-2">
          <div class="col-xs-12 col-sm-10 col-sm-offset-1">
            ...
            <div class="jumbotron m-t-1 m-b-1">
              ...
              <ul>
                <li>"เอกสารประกอบการสมัคร" ที่ดาวโหลดได้จากเว็บไซต์หน้านี้ (ตอบคำถามด้วยนะ)</li>
                <li>สำเนาบัตรประชาชน (พร้อมเซ็นต์สำเนาถูกต้อง)</li>
                <li>ปพ.7 (พร้อมเซ็นต์สำเนาถูกต้อง)</li>
              </ul>
              <div>แล้วติด <span class="text text-danger">"ใบปะหน้าซอง"</span> ที่ดาวโหลดได้จากด้านล่างนี้ลงบนหน้าซองของจดหมาย</div>
